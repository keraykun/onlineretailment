    ...
    <article class="report-list">
       <div class="report-image" >
        ...
        <div  class="report-body">
           ...
           <a href="{{ route('client.report.violation.show',$report->id) }}">Show <i class="fa fa-eye"></i></a>
            @else
            <a href="{{ route('client.report.violation.show',$report->id) }}">Closed <i class="fa fa-eye"></i></a>
           @endif
        </div>
    </article>
    @endforeach
