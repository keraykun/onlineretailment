...
<section class="report-box">
   ...
   <div class="form-content">
    <div class="form-account">
        <form method="POST" action="{{ route('user.setting.detail') }}" style="width:100%;">
            @csrf
            <div class="form-list">
    ...
    <div class="form-picture" style="display: flex; flex-direction:column !important;">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('user.setting.picture') }}">
            @csrf
   ...
   <div class="form-content">
    <div class="form-account">
        <form method="POST" action="{{ route('user.setting.password') }}" style="width:100%;">
            @csrf
            <div class="form-list">
            @error('password')
            <p style="color:red;">{{ $message }}</p>
