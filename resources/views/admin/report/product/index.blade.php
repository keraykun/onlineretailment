...
<section class="report-box">
    <article class="report-title">
        Product Reports List
    </article>
    <div class="search-box">
        <form class="w-full" action="{{ route('admin.report.product.index') }}">
    ...
    <article class="report-list">
       <div class="report-image" >
        ...
        <div class="report-body">
            <a href="{{ route('admin.report.product.show',$report->id) }}">{{ $report->title }}  <i style="font-size: 1.1rem;" class="fa fa-envelope"></i></a>
