    ...
    <article class="report-list">
        <div style="display: flex;">
            ...
            <a href="#report-box-reply"><i class="fa fa-envelope" aria-hidden="true"></i></a>
             <form method="POST" action="{{ route('admin.users.user.solve',$report->id) }}">
                @csrf
                {{ method_field('PATCH') }}
    ...
    <article class="report-list" style="height: 0%;">
        <div class="report-header-reply">
          ...
          <div style="display: flex;">
            ...
            @can('delete',$reply)
            <form method="POST" action="{{ route('admin.users.user.destroy',$reply->id) }}">
                @csrf
                {{method_field('delete')}}
...
<section class="report-box" id="report-box-reply">
    <article class="report-list">
        ...
        <div class="report-footer">
            ...
            @enderror
             <form  style="width:100%;" method="POST" action="{{ route('admin.users.user.store') }}">
                @csrf
