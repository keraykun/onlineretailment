...
<section class="container w-full flex flex-col justify-center items-center flex-shrink-1">
   <aside class="aside-content">
        ...
        <ul class="aside-ul">
           <li class="aside-list {{ Route::is('user.dashboard*')?'active':'' }}"><i class="fa fa-dashboard"></i><a href="{{ route('user.dashboard') }}">Dashboard</a></li>
            <li class="aside-list {{ Route::is('user.order*')?'active':''}}" ><i class="fa fa-list"></i><a href="{{ route('user.orders.index') }}">Order</a></li>
            <li class="aside-list {{ Route::is('user.history*')?'active':''}}" ><i class="fa fa-history"></i><a href="{{ route('user.history.index') }}">History</a></li>
            <li class="aside-list {{ Route::is('user.report*')?'active':''}}"><i class="fa fa-file"></i><a href="{{ route('user.report.refund.index') }}">Refund</a></li>
            <li class="aside-list {{ Route::is('user.violation*')?'active':''}}"><i class="fa fa-warning"></i><a href="{{ route('user.violation.index') }}">Violation</a></li>
            <li class="aside-list {{ Route::is('user.setting*')?'active':''}}"><i class="fa fa-cog"></i><a href="{{ route('user.setting.index') }}">Settings</a></li>
