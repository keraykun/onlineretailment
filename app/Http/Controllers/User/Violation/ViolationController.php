...
namespace App\Http\Controllers\User\Violation;
...
class ViolationController extends Controller
{
    public function index(){
        $user = Auth::user()->id;
         ...
         ->with(['fromuser'])
        ->get();
       return view('user.violation.index',['reports'=>$reports]);
    }
    ...
    public function show(violationReports $data){
        ...
        return view('user.violation.violation_message',['report'=>$report]);
    }
